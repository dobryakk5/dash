...
# Если ещё нет user_info — останавливаем и ждём
if user_info is None:
    st.info("🔐 Пожалуйста, войдите через Telegram")
    st.stop()  # ❗ Главное — остановить исполнение здесь

# Когда пользователь залогинился — следующим рендером user_info уже заполнится
uid = user_info["id"]
